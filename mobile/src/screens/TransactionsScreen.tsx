...
import { getCachedTransactions, getCachedCategories, getCachedLabels, upsertTransactions } from "../offline/db";
...
const makeStyles = (c: ThemeColors) =>
  StyleSheet.create({
    ...
    rangeRow: { marginTop: 10, marginBottom: 2 },
    rangeRowContent: { paddingHorizontal: 16, gap: 8 },
    rangeChip: { paddingHorizontal: 14, paddingVertical: 6, borderRadius: 16, backgroundColor: c.chipBg, marginRight: 8 },
